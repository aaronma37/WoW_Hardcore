...
Hardcore_Settings = {
	version = "0.2.3",
	enabled = true,
	ui_color_scheme = {1, 1, 1, 1},
	show_hc_player_frame = false,

	player_frame = "hardcore",
	party_frame = "hardcore",
	minimap_frame = "hardcore",
	pet_frame = "hardcore",
	target_frame = "hardcore",
	targetToT_frame = "hardcore",
	show_hc_minimap_frame = false,
	show_hc_minimap_frame_animation = false,

	show_hc_target_frame = false,
	show_hc_target_frame_animation = false,

	show_hc_pet_frame = false,
	show_hc_pet_frame_animation = false,
...
function Hardcore:PLAYER_LOGIN()
	...
	self:RegisterEvent("TIME_PLAYED_MSG")
        self:RegisterUnitEvent("UNIT_EXITED_VEHICLE","player");    -- Vehicle exited
