...
function Hardcore_TestRecoveryCode(hardcore_character)
	...
	assert(first_recorded == hardcore_character.first_recorded, "Hardcore_TestRecoverCode::time_tracked_test: Pass " .. first_recorded)
	print("Hardcore_TestRecoverCode::first_recorded: Failed" .. first_recorded)
