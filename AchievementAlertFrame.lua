...
tex:SetHeight(200)
tex:SetWidth(400)
tex:SetTexture("Interface\\Addons\\HardcoreUnlocked\\Media\\achievement_animation_spritesheet.blp")
...
tex2:SetHeight(200)
tex2:SetWidth(400)
tex2:SetTexture("Interface\\Addons\\HardcoreUnlocked\\Media\\achievement_animation_spritesheet2.blp")
...
hc_ring_tex:SetTexture("Interface\\Addons\\HardcoreUnlocked\\Media\\hc-ring.blp")
...
achievement_icon_texture:SetTexture("Interface\\Addons\\HardcoreUnlocked\\Media\\icon_absent_minded_prospector.blp")
...
achievement_icon_texture_white_ring:SetTexture("Interface\\Addons\\HardcoreUnlocked\\Media\\hcring_white.blp")
...
achievement_title_text:SetFont("Interface\\AddOns\\HardcoreUnlocked\\Media\\BreatheFire.ttf", 14, "")
...
function achievement_alert_handler:ShowTimed(_time)
	...
	C_Timer.NewTicker(1 / 30, function(self)
		...
		if counter > 30 then
			...
			achievement_icon_texture_white_ring:SetVertexColor(1, 1, 1, max(0, (50 - counter) / 30))
		else
...
text:SetFont("Interface\\AddOns\\HardcoreUnlocked\\Media\\BreatheFire.ttf", 26, "")
...
t:SetAllPoints()
t:SetTexture("Interface\\Addons\\HardcoreUnlocked\\Media\\alert_border_alpha.blp")
t:SetSize(1000, 1000)
...
t2:SetAllPoints()
t2:SetTexture("Interface\\Addons\\HardcoreUnlocked\\Media\\icon_absent_minded_prospector.blp")
