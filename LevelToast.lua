...
local swipe_x = 0
function HCU_showLegendaryFrame(name, class)
	if class then
	...
	ticker_handler = C_Timer.NewTicker(0.01, function()
		...
		frame.swipe:SetAlpha(swipe_glow / 3.0)
		frame.swipe:SetPoint("LEFT", frame, 50 + swipe_x, 0)
		frame.loottoast:SetAlpha(glow_alpha)
		frame.iconback:SetAlpha(icon_back_alpha)
